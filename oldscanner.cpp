// ,Noah DeFrench, Kyle Monroe, Nicholas Johnson
#include<vector>
...
#include<fstream>
#include<string>
#include <cstdlib> // exit(1) command for empress
using namespace std;

// ------ Three  Tables -------------------------------------

// TABLES Done by: Nicholas Johnson
...
// GLOBAL VARIABLES //////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
ifstream fin;  // stream for reading from the input file
...
//=====================================================
// File scanner.cpp written by: Group Number: 06
//=====================================================
...
//=================================================
// File parser.cpp written by Group Number: 06
//=================================================
...
//RDP FUNCTIONS: These RDP functions contain logic for recursive descent parser
//using our scanner functions and match() and next_token functions. 
//each function calls other functions or terminates scentance; with error checking
//These functions user syntaxerror1 and 2 to produce error messages.
//RETURN: all rdp functions return void.
...
//---------------------------------------------------THIS IS WHERE THE NEW WORK IS!!!VECTOR IS INCLUDED!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
/////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////
...
void getEword(){
  for(int i = 0 ; i < lexicon.size() ; i++){
    if(lexicon.at(i).first == saved_E_lexeme){
      cout << lexicon.at(i).first <<" ---→ " << lexicon.at(i).second << endl;
      saved_E_word = lexicon.at(i).second;
      return;
    }
  }
  cout << saved_E_lexeme << " NOT FOUND!";
  saved_E_word = saved_E_lexeme;
  return;
}
...
int main()
{
  ...
  saved_E_lexeme = "sensei";  // Just for Testing
  getEword();
 ...
 /* FROM LAST PROJECT
    ...
    cout << "Enter the input file name: "; // Output message to user to accept input
    cin >> filename; // cin input to variable filename
    //filename = "t";
    fin.open(filename.c_str()); // command to open file

    //** calls the <story> to start parsing
    //** closes the input file 
    story(); // Call the story function
